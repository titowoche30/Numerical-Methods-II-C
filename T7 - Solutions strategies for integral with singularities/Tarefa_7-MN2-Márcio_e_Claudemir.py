...
def GaussL4(a,b,f,lim_inf,lim_sup,simples=True):
    ...
    if simples:
        #print('retornou =',((b-a)/2)*((exp_simples(X(a, b, c),lim_inf,lim_sup,f))*w1+(exp_simples(X(a, b, d),lim_inf,lim_sup,f))*w2+(exp_simples(X(a, b, e),lim_inf,lim_sup,f))*w2+(exp_simples(X(a, b, g),lim_inf,lim_sup,f))*w1))
